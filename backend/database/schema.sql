...
-- children 테이블에 stop_id 추가 (기존 stop_name 대신)
ALTER TABLE children ADD COLUMN stop_id INT NULL;
ALTER TABLE children ADD FOREIGN KEY (stop_id) REFERENCES stops(id) ON DELETE SET NULL;
